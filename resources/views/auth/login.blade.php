        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-8 bg-white text-gray-800">
            <div class="w-full max-w-md space-y-6">
                        ...
                        <div class="flex justify-between items-center mb-1">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ route('password.request') }}"
                                    class="text-sm font-medium text-gray-600 hover:text-black">Lupa Password?</a>
                            @endif
                        </div>
                ...
                <div class="text-center text-sm text-gray-600">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="font-semibold text-black hover:underline">Daftar
                        Sekarang</a>
                </div>
