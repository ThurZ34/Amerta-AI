...
@section('image_url', 'https://images.unsplash.com/photo-1497294815431-9365093b7331?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')
...
@section('content')
        ...
        <div>
            <div class="flex justify-between items-center mb-1">
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors">Lupa Password?</a>
                @endif
            </div>
    ...
    <div class="text-center text-sm text-gray-600 dark:text-gray-400">
        Belum punya akun?
        <a href="{{ route('register') }}" class="font-semibold text-black dark:text-indigo-400 hover:underline">Daftar Sekarang</a>
    </div>
@endsection
