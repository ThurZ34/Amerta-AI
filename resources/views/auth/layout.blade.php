...
<body class="bg-white dark:bg-gray-950 transition-colors duration-300">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 relative transition-colors duration-300">

            <button @click="toggleTheme()"
                class="absolute top-6 right-6 p-2 rounded-full text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 focus:outline-none transition-colors">
