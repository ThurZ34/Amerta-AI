...
<body
    ...
    <div class="h-screen flex flex-col md:flex-row overflow-hidden relative z-0">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full">
            ...
            <main
                class="flex-1 h-full overflow-y-auto bg-gray-50 dark:bg-gray-900 relative flex flex-col transition-colors duration-300">
                @yield('content')
            </main>
        </div>
    </div>
        ...
        <div x-data="chatWidget" @mousemove.window="doDrag($event)" @mouseup.window="stopDrag()"
            ...
            <div x-show="!isFullscreen" class="fixed bottom-6 right-6 z-[100000]">
                <button @click="chatOpen = !chatOpen"
                    ...
                    <span
                        class="absolute top-0 right-0 w-3.5 h-3.5 bg-red-500 rounded-full border-2 border-white dark:border-gray-900 animate-pulse"></span>
                </button>
            </div>
                ...
                <div @mousedown="startDrag($event)" @dblclick="toggleFullscreen()"
                    ...
                    <div class="flex items-center gap-2">
                        <button @click.stop="toggleFullscreen()"
                            class="text-white/70 hover:text-white p-2 hover:bg-white/10 rounded-lg transition">
