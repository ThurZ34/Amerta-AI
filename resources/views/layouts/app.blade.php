...
<body class="h-full antialiased text-gray-900 bg-gray-50 dark:bg-gray-900 dark:text-gray-100 transition-colors duration-300"
    ...
    <div class="h-screen flex flex-col md:flex-row overflow-hidden relative z-0">
        ...
        @unless (request()->routeIs(['main_menu', 'amerta', 'dashboard-selection', 'dashboard-selection.join', 'marketing-tools']))
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full">
            ...
            <main class="flex-1 h-full overflow-y-auto bg-gray-50 dark:bg-gray-900 relative flex flex-col transition-colors duration-300">
                @yield('content')
            </main>
        </div>
    </div>
    ...
    @unless (request()->routeIs(['dashboard-selection', 'dashboard-selection.join', 'main_menu']))
        <div x-data="chatWidget" 
            ...
            <div x-ref="chatModal" x-show="chatOpen" x-cloak
                    ...
                    <div class="flex items-center gap-2">
                        <button @click.stop="toggleFullscreen()" class="text-white/70 hover:text-white p-2 hover:bg-white/10 rounded-lg transition">
                            ...
                            <svg x-show="isFullscreen" x-cloak class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 9V4.5M9 9H4.5M9 9 3.75 3.75M9 15v4.5M9 15H4.5M9 15l-5.25 5.25M15 9h4.5M15 9V4.5M15 9l5.25-5.25M15 15h4.5M15 15v4.5m0-4.5 5.25 5.25"></path>
                            </svg>
                        </button>
                        <button @click="chatOpen = false; isFullscreen = false; pos = {x:0, y:0}"
                                class="text-white/70 hover:text-white p-2 hover:bg-red-500/80 rounded-lg transition">
