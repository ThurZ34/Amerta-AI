<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="h-20 flex items-center px-6 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
        <a href="{{ route('main_menu') }}" class="flex items-center gap-3 w-full group">
            ...
            <div class="flex flex-col">
                ...
                <span class="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mt-1">UMKM
                    Assistant</span>
            </div>
        </a>
    </div>
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1 custom-scrollbar bg-white dark:bg-gray-950">
        ...
        <p class="px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 mt-1">Analisis & Bantuan</p>
        ...
        <a href="{{ route('analisis.dashboard') }}"
            ...
            <svg class="w-5 h-5 {{ request()->routeIs('analisis.dashboard') ? 'text-indigo-700 dark:text-white' : 'text-gray-400 dark:text-gray-500 group-hover:text-indigo-600 dark:group-hover:text-white' }} transition-colors"
        ...
        <p class="px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 mt-1">Operasional Harian</p>
        ...
        <a href="{{ route('operasional.analisis-penjualan.index') }}"
            ...
            {{ request()->routeIs('operasional.analisis-penjualan.*')
                ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-600 dark:text-white'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
            <svg class="w-5 h-5 {{ request()->routeIs('operasional.analisis-penjualan.*') ? 'text-indigo-700 dark:text-white' : 'text-gray-400 dark:text-gray-500 group-hover:text-indigo-600 dark:group-hover:text-white' }} transition-colors"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('operasional.kasir') }}"
            ...
            {{ request()->routeIs('operasional.kasir')
                ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-600 dark:text-white'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
            <svg class="w-5 h-5 {{ request()->routeIs('operasional.kasir') ? 'text-indigo-700 dark:text-white' : 'text-gray-400 dark:text-gray-500 group-hover:text-indigo-600 dark:group-hover:text-white' }} transition-colors"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="{{ route('operasional.riwayat-keuangan.index') }}"
            ...
            {{ request()->routeIs('operasional.riwayat-keuangan.index')
                ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-600 dark:text-white'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
            <svg class="w-5 h-5 {{ request()->routeIs('operasional.riwayat-keuangan.index') ? 'text-indigo-700 dark:text-white' : 'text-gray-400 dark:text-gray-500 group-hover:text-indigo-600 dark:group-hover:text-white' }} transition-colors"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <p class="px-4 text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 mt-1">Manajemen Bisnis</p>
        ...
        <a href="{{ route('manajemen.profil-bisnis.index') }}"
            ...
            {{ request()->routeIs('manajemen.profil-bisnis.*')
                ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-600 dark:text-white'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                <svg class="w-5 h-5 {{ request()->routeIs('manajemen.profil-bisnis.*') ? 'text-indigo-700 dark:text-white' : 'text-gray-400 dark:text-gray-500 group-hover:text-indigo-600 dark:group-hover:text-white' }} transition-colors"
                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a href="{{ route('manajemen.produk.index') }}"
            ...
            {{ request()->routeIs('manajemen.produk.*')
                ? 'bg-indigo-50 text-indigo-700 dark:bg-indigo-600 dark:text-white'
                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
            <svg class="w-5 h-5 {{ request()->routeIs('manajemen.produk.*') ? 'text-indigo-700 dark:text-white' : 'text-gray-400 dark:text-gray-500 group-hover:text-indigo-600 dark:group-hover:text-white' }} transition-colors"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
