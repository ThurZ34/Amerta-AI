                ...
                <div class="flex flex-col items-center justify-center h-full text-center px-4 fade-in-up">
                    ...
                    @if ($mode === 'full')
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-2xl">
                            ...
                            <button
                                wire:click="sendMessage('Berikan tips praktis untuk meningkatkan penjualan minggu ini')"
                                class="text-left p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-indigo-500 dark:hover:border-indigo-500 hover:shadow-md transition-all group">
                                <span class="text-lg mb-2 block">🎯</span>
                                <h3
                                    class="font-semibold text-gray-800 dark:text-white text-sm group-hover:text-indigo-600 dark:group-hover:text-indigo-400">
                                    Tips Penjualan</h3>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Strategi boost omset.</p>
                            </button>
                            <button
                                wire:click="sendMessage('Apa saja yang harus saya perhatikan dalam mengelola stok?')"
                                class="text-left p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-indigo-500 dark:hover:border-indigo-500 hover:shadow-md transition-all group">
                                <span class="text-lg mb-2 block">📦</span>
                                <h3
                                    class="font-semibold text-gray-800 dark:text-white text-sm group-hover:text-indigo-600 dark:group-hover:text-indigo-400">
                                    Manajemen Stok</h3>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Kelola inventori.</p>
                            </button>
                        </div>
                    @endif
                </div>
                            ...
                            <div x-data="{
                                ...
                                <div class="px-5 py-4 pb-2">
                                    <div x-ref="content"
                                        ...
                                        :style="isOverflowing ? ('height: ' + (expanded ? $refs.content.scrollHeight + 'px' :
                                            '160px')) : ''">
                                    ...
                                    <div x-show="isOverflowing"
                                        ...
                                        @click="expanded = !expanded">
                                        <div
                                            class="text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 transition-colors bg-white dark:bg-gray-800 rounded-full px-2 shadow-sm border border-gray-100 dark:border-gray-700">
                                            <svg x-show="!expanded" class="w-6 h-6 animate-pulse" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" />
                                            </svg>
                                            <svg x-show="expanded" class="w-6 h-6" fill="none"
                                ...
                                <div x-data="{
                                    ...
                                    <button @click="copyToClipboard()"
                                        class="p-1 text-gray-400 hover:text-indigo-600 bg-gray-50 dark:bg-gray-700 rounded">
