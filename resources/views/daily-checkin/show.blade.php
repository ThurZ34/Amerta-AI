...
@section('content')
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 pb-40" x-data="{ editModalOpen: false, detailModalOpen: false, isLoading: false }">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
                class="bg-white dark:bg-slate-900 text-gray-900 dark:text-white rounded-3xl p-8 mb-24 shadow-xl border border-gray-200 dark:border-slate-700 relative overflow-hidden">
                <div
                    class="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-indigo-500 rounded-full blur-3xl opacity-10 dark:opacity-20">
                </div>
                <div
                    class="absolute bottom-0 left-0 -mb-10 -ml-10 w-40 h-40 bg-purple-500 rounded-full blur-3xl opacity-10 dark:opacity-20">
                </div>

                <div class="relative z-10">
                    <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100 dark:border-slate-700/50">
                        <div
                            class="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Analisa Amerta AI</h3>
                            <p class="text-gray-500 dark:text-slate-400 text-sm">Insight cerdas berdasarkan performa
                                penjualan Anda hari ini.
                            </p>
                        </div>
                    </div>

                    <div
                        class="prose prose-slate dark:prose-invert max-w-none md:columns-2 gap-12 prose-p:leading-relaxed prose-li:marker:text-indigo-500 dark:prose-li:marker:text-indigo-400">
                        @if ($dailySale->ai_analysis === 'Menunggu analisis...' || $dailySale->ai_analysis === 'Analyzing...')
                            <div class="flex flex-col items-center justify-center py-12 text-center">
                                <div
                                    class="w-16 h-16 bg-indigo-50 dark:bg-indigo-500/20 rounded-2xl flex items-center justify-center mb-4">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Laporan Belum Dianalisis
                                </h3>
                                <p class="text-gray-500 dark:text-slate-400 max-w-md mb-6">Data penjualan dari kasir telah
                                    masuk. Silakan periksa kembali kelengkapan data sebelum melakukan analisis AI.</p>
                                <button @click="editModalOpen = true"
                                    class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg hover:shadow-indigo-500/25 transition-all active:scale-95 flex items-center gap-2">
