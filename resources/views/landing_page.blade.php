@php
    ...
    $features = [
        [
            ...
            'desc' => 'Optimized for speed and performance, ensuring your users have the best experience.',
            'color' => 'indigo',
            'icon' => 'M13 10V3L4 14h7v7l9-11h-7z',
        ],
        [
            'title' => 'Secure by Design',
            'desc' => 'Built with security in mind. Your data is protected with enterprise-grade encryption.',
            'color' => 'purple',
            'icon' =>
        ...
        [
            'title' => 'Easy to Use',
            'desc' => 'Intuitive interface that requires no training. Get up and running in minutes.',
            'color' => 'pink',
            'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
        ],
        [
            'title' => 'Analytics',
            'desc' => 'Gain deep insights into your performance with our advanced analytics dashboard.',
            'color' => 'blue',
            'icon' => 'M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z',
        ],
        [
            'title' => 'Team Collaboration',
            'desc' => 'Share, comment, and collaborate in real-time to get work done faster.',
            'color' => 'orange',
            'icon' =>
...
<body class="antialiased bg-gray-50 dark:bg-gray-950 text-slate-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 relative z-10 text-center fade-in-section">
            <div
                class="inline-flex items-center px-4 py-2 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-sm font-medium mb-8 border border-indigo-100 dark:border-indigo-800">
            ...
            <h1 class="text-5xl md:text-7xl font-extrabold text-slate-900 dark:text-white mb-8 leading-tight">
                {{ __('Build your dream') }} <br> <span
                    class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">{{ __('with Amerta') }}</span>
            </h1>
            <p class="mt-4 max-w-2xl mx-auto text-xl text-slate-600 dark:text-gray-400 mb-10">
                {{ __('A powerful platform designed to help you achieve your goals faster and more efficiently.') }}
            </p>
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="{{ route('register') }}"
                    class="px-8 py-4 bg-indigo-600 text-white rounded-full font-semibold hover:bg-indigo-700 shadow-xl flex items-center justify-center gap-2">{{ __('Start Free Trial') }}
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                    </svg></a>
                <a href="#about"
                    class="px-8 py-4 bg-white dark:bg-gray-800 text-slate-700 dark:text-gray-200 border border-gray-200 dark:border-gray-700 rounded-full font-semibold hover:bg-gray-50 flex items-center justify-center gap-2">{{ __('Learn More') }}</a>
            </div>
        ...
        <div class="absolute top-0 left-1/2 w-full -translate-x-1/2 h-full z-0 pointer-events-none">
            <div id="blob-1"
                class="absolute top-20 left-10 w-96 h-96 bg-purple-200 dark:bg-purple-900/20 rounded-full mix-blend-multiply blur-3xl opacity-30 animate-blob">
            </div>
            <div id="blob-2"
                class="absolute top-20 right-10 w-96 h-96 bg-indigo-200 dark:bg-indigo-900/20 rounded-full mix-blend-multiply blur-3xl opacity-30 animate-blob animation-delay-2000">
            </div>
            <div id="blob-3    $navLinks = [
"
                class="absolute -bottom-8 left-1/2 w-96 h-96 bg-pink-200 dark:bg-pink-900/20 rounded-full mix-blend-multiply blur-3xl opacity-30 animate-blob animation-delay-4000">
            </div>
        </div>
    </div>
    ...
    <div id="about" class="py-24 bg-white dark:bg-gray-950 relative">
        <div class="max-w-7xl mx-auto px-4 lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div class="mb-12 lg:mb-0 relative fade-in-left">
                <div class="absolute -top-4 -left-4 w-24 h-24 bg-indigo-100 dark:bg-indigo-900/30 rounded-full -z-10">
                </div>
                <div
