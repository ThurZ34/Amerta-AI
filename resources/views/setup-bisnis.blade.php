        ...
        <div class="w-full max-w-[1200px] bg-white dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl dark:shadow-secondary-900/20 border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col lg:flex-row relative z-10 min-h-[700px] transition-colors duration-300"
            x-data="{
                ...
                validateStep() {
                    ...
                    if (this.step === 1) {
                        if (!this.formData.nama_bisnis.trim()) { this.errors.nama_bisnis = true;
                            isValid = false; }
                        if (!this.formData.status_bisnis) { this.errors.status_bisnis = true;
                            isValid = false; }
                        if (!this.formData.kategori_bisnis) { this.errors.kategori_bisnis = true;
                            isValid = false; }
                        ...
                        if (!this.formData.channel_penjualan) { this.errors.channel_penjualan = true;
                            isValid = false; }
                        if (!this.formData.target_pasar.trim()) { this.errors.target_pasar = true;
                            isValid = false; }
                        if (!this.formData.range_omset) { this.errors.range_omset = true;
                            isValid = false; }
                    } else if (this.step === 3) {
                        if (!this.formData.jumlah_tim) { this.errors.jumlah_tim = true;
                            isValid = false; }
                        if (!this.formData.tujuan_utama.trim()) { this.errors.tujuan_utama = true;
                            isValid = false; }
                    }
            ...
            <div class="w-full lg:w-7/12 flex flex-col h-full">
                ...
                <!-- Footer Buttons -->
                <div class="px-8 py-6 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
                    <div class="flex justify-between items-center">
                        ...
                        <button type="button" x-show="step === totalSteps"
                            @click="if(validateStep()) { /* Submit logic here */ }" x-cloak
