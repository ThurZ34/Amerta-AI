...
@section('content')
    ...
    <div
        ...
        <div class="absolute inset-0 w-full h-full">
            ...
            <div
                class="absolute bottom-0 right-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl mix-blend-multiply dark:mix-blend-screen animate-blob animation-delay-2000">
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex justify-between items-start mb-6">
                            <div
                                class="w-14 h-14 rounded-2xl bg-indigo-100 dark:bg-indigo-900/50 flex items-center justify-center text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform duration-300">
                            ...
                            <span
                                class="px-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-xs font-bold uppercase tracking-wider border border-indigo-100 dark:border-indigo-800">Untuk
                                Owner</span>
                        </div>
                        ...
                        <p class="text-slate-500 dark:text-gray-400 mb-8 leading-relaxed">
                            Saya ingin membuat ruang kerja baru, mengatur produk, dan memantau keuangan bisnis saya dari
                            nol.
                        </p>
                        <div class="mt-auto">
                            <a href="{{ route('setup-bisnis') }}"
                                class="flex items-center justify-center w-full py-4 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-lg shadow-indigo-200 dark:shadow-indigo-900/30 transition-all active:scale-95">
                                Mulai Setup Bisnis
                ...
                <div
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex justify-between items-start mb-6">
                            <div
                                class="w-14 h-14 rounded-2xl bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform duration-300">
                                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if (Auth::user()->business_id)
                            ...
                            <p class="text-slate-500 dark:text-gray-400 mb-6">
                                ...
                                <strong
                                    class="text-emerald-600 dark:text-emerald-400">{{ Auth::user()->business->nama_bisnis }}</strong>.
                            </p>
                            <div class="mt-auto">
                                <a href="{{ route('analisis.dashboard') }}"
                                    class="flex items-center justify-center w-full py-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-lg shadow-emerald-200 dark:shadow-emerald-900/30 transition-all active:scale-95">
                                    Masuk Main Menu
                                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @elseif(isset($pendingRequest) && $pendingRequest)
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-amber-600 dark:text-amber-400">Request dikirim ke:
                                            <strong>{{ $pendingRequest->business->nama_bisnis }}</strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-auto space-y-3">
                                ...
                                <a href="{{ url('/') }}"
                                    class="block w-full text-center py-3 rounded-xl border border-slate-200 dark:border-gray-700 text-slate-500 dark:text-gray-400 hover:bg-slate-50 dark:hover:bg-gray-700 font-semibold transition-colors">
                                    Kembali ke Beranda
                                </a>
                            </div>
                        @else
                            ...
                            <div class="mt-auto space-y-4">
                                ...
                                <p class="text-center text-xs text-slate-400 mt-4">Tanya pemilik bisnis untuk kode
                                    akses
                                </p>
                            </div>
                        @endif
